...
/**
 * ReentrantLock으로 생산자/소비자 condition 분리
 *
 * object waite, notify 는 임의의 쓰레드가 꺠어남(syncronized 블록안에서)
 * Condition signal은 대기중인 스레드 선입선출방식으로 꺼냄
 */
public class BoundedQueueV5 implements BoundedQueue{
    ...
    private final Condition producerCond = lock.newCondition(); //Producer thread 대기 집합p
    private final Condition consumerCond = lock.newCondition(); //Consumer thread 대기 집합
